...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4163&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-boruta-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-boruta` can be installed with `conda`:
...
```
mamba install r-boruta
```

It is possible to list all of the versions of `r-boruta` available on your platform with `conda`:
...
```
mamba search r-boruta --channel conda-forge
```
...
mamba repoquery search r-boruta --channel conda-forge

# List packages depending on `r-boruta`:
mamba repoquery whoneeds r-boruta --channel conda-forge

# List dependencies of `r-boruta`:
mamba repoquery depends r-boruta --channel conda-forge
```
